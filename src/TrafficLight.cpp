...
{
    _currentPhase = TrafficLightPhase::vRed;
}
...
void TrafficLight::waitForGreen()
{
    ...
    while (true) {
    	...
    	if (message == TrafficLightPhase::vGreen)
      		return;
  	}
}
...
void TrafficLight::cycleThroughPhases()
{
    ...
    while (true) {
      ...
      if (t_delta >= cycleTime) {
        ...
        if (_currentPhase == TrafficLightPhase::vGreen)
          _currentPhase = TrafficLightPhase::vRed;
        else if (_currentPhase == TrafficLightPhase::vRed)
          _currentPhase = TrafficLightPhase::vGreen;
